...
# look for .env file and load environment variables from it
load_dotenv()
...
def main():
    ...
    print("Here is the fake api key: ", os.environ.get("LANGSMITH_API_KEY"))
    ...
    # each of this have runnable interface
    chain = summary_prompt_template | llm
    response = chain.invoke({"information": information})
    print('ai answer: ' + '-' * 80)
    print(response.content)
    print('finish answer: ' + '-' * 80)
